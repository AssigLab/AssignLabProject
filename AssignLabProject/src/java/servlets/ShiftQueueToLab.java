 ...
 */
public class ShiftQueueToLab extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Lab currentLab = (Lab) request.getSession().getAttribute("lab");

            Lab lab = new Lab();
            lab.setName(selectedLab);

            Lab toShifteslab = new LabDAO().getLabByName(lab);

            System.out.println(toShifteslab.getName());
