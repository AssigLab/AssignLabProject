...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
       <link rel="stylesheet" href="http://localhost:8080/AssignLabProject/studentcss/reset.css" type="text/css" media="all">
        <link rel="stylesheet" href="http://localhost:8080/AssignLabProject/studentcss/style.css" type="text/css" media="all">
        <script type="text/javascript" src="http://localhost:8080/AssignLabProject/studentjs/jquery-1.4.2.min.js" ></script>
        <script type="text/javascript" src="http://localhost:8080/AssignLabProject/studentjs/cufon-yui.js"></script>
        <script type="text/javascript" src="http://localhost:8080/AssignLabProject/studentjs/cufon-replace.js"></script>
        <script type="text/javascript" src="http://localhost:8080/AssignLabProject/studentjs/Myriad_Pro_300.font.js"></script>
        <script type="text/javascript" src="http://localhost:8080/AssignLabProject/studentjs/Myriad_Pro_400.font.js"></script>
        <script type="text/javascript" src="http://localhost:8080/AssignLabProject/studentjs/script.js"></script>
        ...
        <div class="wrap">
            <header>
                <div class="container">
                    ...
                    <nav>
                        <ul>
                            <li class="current"><a href="http://localhost:8080/AssignLabProject/StudentView/StudentView.jsp" class="m1">Home</a></li>
                            <li><a href="http://localhost:8080/AssignLabProject/StudentView/aboutUs.html" class="m2">About Us</a></li>
                            <li class="last"><a href="http://localhost:8080/AssignLabProject/StudentView/schedule.html" class="m3">Schedule</a></li>
                            <li class="last">
            ...
            <div class="container">
                <aside>
                    <h3>Groups</h3>
                    <ul class="categories">
                        <li><span><a href="#">Group1</a></span></li>
                        <li><span><a href="#">Group2 </a></span></li>
                        <li><span><a href="#">Group3</a></span></li>
                        <li class="last"><span><a href="#">Group4</a></span></li>
                    </ul>
                ...
                <section id="content">
                    ...
                    <div id="openuploadModal" class="modalDialog">
                        <div>
                            ...
                            <form class="m-t" role="form" action="Trainee/UploadServlet"  method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        <div class="ibox " id="ass-que">
                            ...
                            <div class="ibox-bottom">
                               <form class="m-t" role="form" action="Trainee/CancelAssistanceQueueRequest" methode="post">
                        ...
                        <div class="ibox " id="del-que">
                            ...
                            <div class="ibox-bottom">
                                 <form class="m-t" role="form" action="Trainee/CancelDeliveryQueueRequest" methode="post">
                ...
                <!--Modal Dialog for Delete group  -->
                  ...
                  <div id="openModal1" class="modalDialog">
                    <div>
                        ...
                        <a href="#close" title="Close" class="close">X</a>
                        <form class="m-t" role="form" action="Trainee/RequestDeliveryQueueServlet" methode="post">
                            <table class="popup-form">
                                <tr>
                                    <td colspan="2">
                ...
                <div id="openModal" class="modalDialog">
                    <div>
                        ...
                        <a href="#close" title="Close" class="close">X</a>
                        <form class="m-t" role="form" action="Trainee/RequestAssistantQueueServlet" methode="post">
                            <table class="popup-form">
                                <tr>
                                    <td colspan="2">
                                        <div id="popup_form_header">Request</div>
