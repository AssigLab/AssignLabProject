            ...
            <div class="container">
                ...
                <section id="content">
                    <div class="inside" id="inside_form">
                        <form class="m-t" role="form" action="GetLabs" >
                            <table class="form_table">
                                <tr>
                                    <td colspan="2">
                                        <div id="form_header">Select Course</div>
                                    </td>
                                    <td></td>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <select class="form-control" name=course>
                                                ...
                                                <c:forEach var="courseString" items="${sessionScope.courses}" >
                                                    <%--<c:choose>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <button type="submit" class="btn btn-create block full-width m-b" >Get Labs</button>
