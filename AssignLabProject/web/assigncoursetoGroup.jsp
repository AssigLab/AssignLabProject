...
<html lang="en">
    <head>
        <title>Assign Course to Group</title>
        <meta charset="utf-8">
                    ...
                    <div class="inside" id="inside_form">
                        <form class="m-t" role="form" action="Home.jsp">
                            <table class="form_table">
                                <tr>
                                    <td colspan="2">
                                        <div id="form_header">Assign Course to Group</div>
                                    </td>
                                    <td></td>
                                ...
                                <form class="m-t" role="form" action="Home.jsp">
                                    <table class="popup-form">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" class="form-control"  id="popup_txt1" placeholder="CourseName" readonly="" >
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
