                    ...
                    <div class="inside" id="inside_form">
                        <form class="m-t" role="form" action="index.jsp">
                            <table class="form_table">
                                <tr>
                                    <td colspan="2">
                                        <div id="form_header">Delete Group</div>
                                    </td>
                                    <td></td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <button type="button" class="btn btn-create block full-width m-b" ><a id="link_btn" href="#openModal">Delete</a></button>
                            ...
                            <div>
                                ...
                                <form class="m-t" role="form" action="index.jsp">
                                    <table class="popup-form">
                                        <tr>
                                            <td colspan="2">
                                                <div id="popup_form_header">Delete Group</div>
                                            </td>
                                            <td></td>
