...
<html lang="en">
    <head>
        ...
        <!--get All Active groups from request --> 
            ...
            <div class="container">
                ...
                <section id="content">
                    <div class="inside" id="inside_form">
                        <form class="m-t" role="form"  method="post" action="validateNameUpdateGroup">
                            <table class="form_table">
                                <tr>
                                    <td colspan="2">
                                        <div id="form_header">Update Groups</div>
                                    </td>
                                    <td></td>
                            ...
                            <div id="openModal" class="modalDialog">
                                <div>
                                    ...
                                    <table class="popup-form">
                                        <tr>
                                            <td colspan="2">
                                                <div id="popup_form_header">Update Group</div>
                                            </td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="name"  id="popup_txt1" placeholder="Group Name" required="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <textarea class="form-control" name="description" id="popup_txt2" placeholder="Group Description" required=""> </textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
