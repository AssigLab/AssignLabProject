                    ...
                    <div class="inside" id="inside_form">
                        <form class="m-t" role="form" action="index.jsp">
                            <table class="form_table">
                                <tr>
                                    <td colspan="2">
                                        <div id="form_header">Update Group</div>
                                    </td>
                                    <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" class="form-control"  id="popup_txt1" placeholder="GroupName" required="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <textarea class="form-control" id="popup_txt2" placeholder="GroupDescription" required=""> </textarea>
